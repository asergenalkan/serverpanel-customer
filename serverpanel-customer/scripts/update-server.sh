...
#
# Kullanım:
#   curl -sSL https://raw.githubusercontent.com/asergenalkan/serverpanel-customer/main/scripts/update-server.sh | bash
#
# veya sunucuda:
...
GITHUB_REPO="asergenalkan/serverpanel-customer"
